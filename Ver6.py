# Ver6.py
# Changes made:
# 1. Multiple stock comparison (side-by-side charts).
# 2. SMA/EMA selection (user chooses type and window size).
# Inherited all features from Ver5_Enhanced4.py:
...
# Title
st.title("📈 Stock Market Dashboard - V6")
st.write("RUNNING: Ver6.py")
